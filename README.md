...
* **Wavelet Denoising:**  Νoise estimation to isolate true neural signals from complex background artifacts without distorting the underlying data structure.
...
* **Automated Data Structuring:** Aggregates all extracted physiological features (RMS, Alpha, Beta, Gamma power) into structured arrays and automates the export to `.xlsx` format for seamless integration into electronic health records (EHR) databases or statistical software.

## Technologies & Methods Used
* **Language:** MATLAB
* **Key Techniques:** Time-Series Trimming, Resampling, Wavelet Denoising, Power Spectral Density (PSD) Estimation, Clinical Feature Extraction.
